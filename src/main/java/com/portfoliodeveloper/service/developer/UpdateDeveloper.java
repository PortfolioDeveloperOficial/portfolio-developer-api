...
public class UpdateDeveloper {
    ...
    public void execute(final Developer.DTO dto) {
        ...
        developer.setBirthDate(Optional.ofNullable(dto.getBirthDate()).orElse(developer.getBirthDate()));
        ...
        developer.setNeighborhood(Optional.ofNullable(dto.getNeighborhood()).orElse(developer.getNeighborhood()));
